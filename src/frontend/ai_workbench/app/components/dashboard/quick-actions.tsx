    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      {mockQuickActions.map((action, index) => {
        ...
        return (
          <div 
            key={action.id}
            className={`${action.color} border rounded-xl p-6 hover:shadow-md transition-all duration-300 cursor-pointer group transform hover:-translate-y-1 opacity-0 animate-slide-up`}
