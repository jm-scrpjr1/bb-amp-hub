...
import { X, Clock, ExternalLink } from '@/components/icons';
import GenieModal from './genie-modal';

interface TrackTimeModalProps {
  isOpen: boolean;
  onClose: () => void;
  triggerElement?: HTMLElement | null;
}

interface TimeTrackingPlatform {
  id: string;
  name: string;
  url: string;
  description: string;
...
const TrackTimeModal = memo(function TrackTimeModal({ isOpen, onClose, triggerElement }: TrackTimeModalProps) {
  ...
  const platforms: TimeTrackingPlatform[] = [
    {
      id: 'tsheet',
      name: 'TSheets',
