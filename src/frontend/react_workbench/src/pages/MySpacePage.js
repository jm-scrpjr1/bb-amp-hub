...
const MySpacePage = () => {
  ...
  const handleDirectMessageClick = (recipientName, event) => {
    if (event) {
  ...
  const handleGroupChatClick = (groupName, event) => {
    if (event) {
      event.preventDefault();
      event.stopPropagation();
    }
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  <div
                    ...
                    onClick={(event) => handleDirectMessageClick('Ron Rivero', event)}
                  >
                  ...
                  <div
                    className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors"
                    onClick={(event) => handleDirectMessageClick('Amanda Simmons', event)}
                  >
                  ...
                  <div
                    className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors"
                    onClick={(event) => handleDirectMessageClick('Aaron Jay Buenaventura', event)}
                  >
                  ...
                  <div
                    className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors"
                    onClick={(event) => handleDirectMessageClick('Czar Chavez', event)}
                  >
                  ...
                  <div
                    className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors"
                    onClick={(event) => handleDirectMessageClick('Dustin Johnson', event)}
                  >
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div
                    className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors"
                    onClick={(event) => handleGroupChatClick('Marketing Team', event)}
                  >
